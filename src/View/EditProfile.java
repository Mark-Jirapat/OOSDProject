...
public class EditProfile extends javax.swing.JPanel {
    ...
    public EditProfile(Controller controller,UserDetail user) {
        ...
        txtSocialNo.setText(user.getSocialNo());
        txtFirstName.setText(user.getFirstName());
        txtLastName.setText(user.getLastName());
        txtTelephoneNo.setText(user.getTelephoneNo());
    ...
    private void initComponents() {
        ...
        emptyPanelLayout.setVerticalGroup(
            ...
            .addGroup(emptyPanelLayout.createSequentialGroup()
                ...
                .addGroup(emptyPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblAddress)
                    .addComponent(scrollPaneForTxtAddress, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(emptyPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnCancel)
                    .addComponent(btnConfirm))
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        controller.btnConfirmOnEditProfile(password, rePassword, firstName, lastName, gender, telephoneNo, address);
