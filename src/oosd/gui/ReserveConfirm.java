 ...
 * @author USER
 */
public class ReserveConfirm extends javax.swing.JPanel {

    public ReserveConfirm(Frame frame) {
        initComponents();
        setBounds(0, 0, 800, 600);
        add(new Header("Reservation : Confirmation"));
    }
    ...
    private void initComponents() {
        ...
        CancelRe.setBackground(new java.awt.Color(255, 204, 0));
        CancelRe.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 14)); // NOI18N
        CancelRe.setText("Cancel Reserve");
